...
class BrowserContextBase extends events_2.EventEmitter {
    ...
    async _initialize() {
        if (helper_1.helper.isDebugMode() || helper_1.helper.isRecordMode()) {
            this._debugController = new debugController_1.DebugController(this, {
                recorderOutput: helper_1.helper.isRecordMode() ? process.stdout : undefined
            });
        }
    }
    _initDebugModeForTest(options) {
        this._debugController = new debugController_1.DebugController(this, options);
