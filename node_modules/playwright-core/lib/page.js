...
class Page extends events_2.EventEmitter {
    ...
    async waitForEvent(event, optionsOrPredicate = {}) {
        ...
        return progressController.run(progress => helper_1.helper.waitForEvent(progress, this, event, options.predicate));
    }
...
class PageBinding {
    ...
    static async dispatch(page, payload, context) {
        ...
        context.evaluateInternal(expression).catch(logger_1.logError(page._logger));
