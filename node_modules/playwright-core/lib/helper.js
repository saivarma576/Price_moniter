...
exports.helper = exports.logPolitely = exports.getFromENV = exports.assertMaxArguments = exports.debugAssert = exports.isUnderTest = exports.setUnderTest = exports.assert = exports.deprecate = void 0;
...
class Helper {
    ...
    static async waitForEvent(progress, emitter, event, predicate) {
        const listeners = [];
        ...
        progress.cleanupWhenAborted(() => exports.helper.removeEventListeners(listeners));
