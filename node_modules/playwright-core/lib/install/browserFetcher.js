...
function getDownloadUrl(browserName, platform) {
...
async function downloadBrowserWithProgressBar(browserPath, browser) {
...
async function canDownload(browserName, browserRevision, platform) {
