...
exports.ProgressController = exports.runAbortableTask = exports.isRunningTask = void 0;
...
exports.isRunningTask = isRunningTask;
...
class ProgressController {
    ...
    async run(task) {
        ...
        try {
            ...
            this._aborted();
            stackTrace_1.rewriteErrorMessage(e, e.message + formatLogRecording(loggerScope.recording(), this._apiName) + kLoggingNote);
            clearTimeout(timer);
            this._state = 'aborted';
